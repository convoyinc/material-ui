...
var DatePickerDialog = React.createClass({
  ...
  show: function show() {
    ...
    // A hack to work around MUI's dialog resetting the scroll position.
    //
    // TODO: This is fixed on MUI master, but bumping it is invasive right now.
    // This should be reverted/forgotten when we sync up.
